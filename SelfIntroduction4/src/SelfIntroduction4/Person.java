...
public class Person {
	...
	// メソッドを定義し引数にクラスの変数を指定
	public void buy(Car car1) {
		car1.setOwner(this.fullName());
		System.out.println(car1.getOwner() + "が購入しました");
	}
	
	public void buy(Bicycle bicycle1) {
		bicycle1.setOwner(this.fullName());
		System.out.println(bicycle1.getOwner() + "が購入しました");
	}
